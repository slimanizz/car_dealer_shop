 ...
 * Use the {@link AdminViewReservation#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminViewReservation extends Fragment {
     ...
     * @return A new instance of fragment AdminViewReservation.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminViewReservation newInstance(String param1, String param2) {
        AdminViewReservation fragment = new AdminViewReservation();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_view_reservation, container, false);
        ...
        while (cursor.moveToNext()){
            ...
            if(cursor1.getCount()>0){
                string = cursor1.getString(3) + " " + cursor1.getString(4) + "\n" +
                        Car.allCars.get(Integer.parseInt(cursor.getString(1))).getType() + " " +
                        Car.allCars.get(Integer.parseInt(cursor.getString(1))).getId() + "\n" +
                        cursor.getString(2);
